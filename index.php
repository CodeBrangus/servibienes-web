...
define('ADMIN_PASSWORD', 'SERVIBIENES2026');
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
.to-top-btn:hover{transform: translateY(-1px);}
...
.event-card-img img{ width:100%; height: 180px; object-fit: contain; background: rgba(255,255,255,0.06); display:block; }
.event-card-body{ padding: 14px 14px 18px; }
.event-card-title{ font-weight: 900; font-size: 16px; margin-bottom: 8px; }
.event-card-desc{ color: var(--muted); font-size: 13px; line-height: 1.5; }

@media (max-width: 560px){
    .event-card-img img{ height: 150px; }
}

/* Fix móvil: padding del contenedor principal para que NO se recorte el representante */
@media (max-width: 560px){
    .site{ padding: 16px; margin: 10px auto; }
}

        /* Foto representante */
        .rep-photo {width:140px;height:140px;border-radius:50%;object-fit:cover;margin:0 auto 18px;display:block;border:3px solid rgba(255,255,255,0.12);}
        .rep-photo-placeholder {width:140px;height:140px;border-radius:50%;background:rgba(255,255,255,0.06);display:flex;align-items:center;justify-content:center;margin:0 auto 18px;border:3px dashed rgba(255,255,255,0.12);}
        .rep-photo-placeholder i {font-size:52px;color:var(--muted);}
        ...
        * {
        ...
        .hero-menu a, .hero-dropbtn{
            color: #102a43;
            font-weight: 900;
        }
        /* Lineas de encabezado (menu) */
        .hero-menu a, .hero-dropbtn{position:relative; padding:10px 10px; border-radius:10px;}
        .hero-menu a::after, .hero-dropbtn::after{
            content:'';
            position:absolute;
        ...
        .hero-dropbtn:hover::after, .hero-dropdown.open .hero-dropbtn::after{
            transform:scaleX(1);
        }
...
.hero-overlay{
        ...
        @media (max-width: 980px){
            .hero-overlay{ padding: 52px 18px; }
        }

        @media (max-width: 860px){
            .hero-topbar{flex-wrap: wrap; justify-content: space-between;}
            .hero-cta{width: auto;}
        }

        
        /* Dropdown Proyectos (funciona en móvil y escritorio) */
        .hero-menu{display:flex;align-items:center;gap:18px;flex-wrap:wrap;}
        ...
        .hero-dropmenu a:hover{background:rgba(11,35,64,.06);}
        ...
        .project-block-thumbs{overflow:hidden;}
        .thumb-track{display:flex;gap:10px;transition:transform .6s ease;will-change:transform;}
        .thumb-track img{width:140px;height:100px;object-fit:cover;border-radius:14px;flex-shrink:0;}
        @media (max-width: 560px){
            .thumb-track img{width:120px;height:88px;}
        }
        ...
        @media (max-width: 980px){
            ...
            .below-hero{justify-items:center;}
            .rep{max-width:520px;width:100%;margin-left:auto;margin-right:auto;}
        }
        @media (max-width: 560px){
            .rep{padding:16px;border-radius:18px;max-width:420px;width:calc(100% - 24px);margin-left:auto;margin-right:auto;}
        ...
        @media (max-width: 420px){
            .rep{padding:14px;border-radius:16px;max-width:380px;width:calc(100% - 20px);margin-left:auto;margin-right:auto;}
            .rep-photo{max-width:300px;}
            .rep-photo-placeholder{max-width:300px;height:200px;}
            .rep h3{font-size:18px;}
            .rep p{font-size:13px;}
        }
        ...
        .rep{margin-left:auto;margin-right:auto;}
        ...
        .below-left{min-width:0; max-width:100%;}
                @media (min-width: 981px){
            .below-hero{ grid-template-columns: 1fr 400px; }
        }

        /* Anti-desborde horizontal en móviles */
        html, body{max-width:100%; overflow-x:hidden;}
        .rep{justify-self:center; width:100%; max-width:520px;}
        ...
        @media (max-width: 420px){
            .rep{padding:14px;border-radius:16px;max-width:380px;width:calc(100% - 20px);}
            .rep-photo,
            .rep img{max-width:300px !important;}
            .rep-photo-placeholder{max-width:300px !important;height:200px !important;}
            .rep h3{font-size:18px;}
            .rep p{font-size:13px;}
        }
        ...
        /* Logo Animation */
        @keyframes logoGlow {
            0% { box-shadow: 0 0 5px var(--sky), 0 0 10px var(--sky), 0 0 15px var(--sky); }
            50% { box-shadow: 0 0 20px var(--accent), 0 0 30px var(--accent), 0 0 40px var(--accent); }
            100% { box-shadow: 0 0 5px var(--sky), 0 0 10px var(--sky), 0 0 15px var(--sky); }
        }
        ...
        .quick-properties { padding: 38px 0 10px; }
        .quick-columns { display: grid; grid-template-columns: repeat(3, 1fr); gap: 18px; }
        .quick-col { padding: 18px; border-radius: 18px; background: linear-gradient(135deg, rgba(255,255,255,0.03), rgba(255,255,255,0.01)); border: 1px solid rgba(255,255,255,0.06); }
        .quick-col-head { display: flex; align-items: center; justify-content: space-between; gap: 10px; margin-bottom: 12px; }
        .quick-col-head h4 { margin: 0; color: var(--sky); font-size: 18px; }
        .prop-mini-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px; }
        .prop-mini { display: block; text-decoration: none; color: inherit; border-radius: 14px; overflow: hidden; border: 1px solid rgba(255,255,255,0.06); background: rgba(255,255,255,0.02); transition: transform .15s ease, border-color .15s ease; }
        .prop-mini:hover { transform: translateY(-2px); border-color: rgba(255,215,0,0.45); }
        .prop-mini-img { height: 110px; background: rgba(255,255,255,0.03); display:flex; align-items:center; justify-content:center; }
        .prop-mini-img img { width: 100%; height: 100%; object-fit: contain; background: rgba(255,255,255,0.06);} 
        .prop-mini-img.placeholder { color: rgba(255,255,255,0.55); font-size: 28px; }
        .prop-mini-body { padding: 10px; }
        .prop-mini-title { font-weight: 700; font-size: 13px; line-height: 1.2; margin-bottom: 6px; }
        .prop-mini-meta { font-size: 12px; color: rgba(255,255,255,0.75); display:flex; gap: 6px; align-items:center; }
        .prop-mini-price { margin-top: 6px; font-weight: 700; color: var(--gold); font-size: 13px; }

        /* ====== NUEVAS SECCIONES: lista de proyectos ====== */
        .projects-list-section { margin-top: 26px; padding: 30px; border-radius: 20px; background: linear-gradient(135deg, rgba(255,255,255,0.03), rgba(255,255,255,0.01)); border: 1px solid rgba(255,255,255,0.05); }
        .projects-list-grid { display: flex; flex-direction: column; gap: 18px; margin-top: 18px; }
        .project-block { padding: 16px; border-radius: 18px; background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.06); }
        .project-block-header { display:flex; align-items:center; justify-content: space-between; gap: 12px; margin-bottom: 12px; }
        .project-block-header h4 { margin: 0; color: var(--sky); font-size: 16px; }
        .project-block-thumbs { position: relative; }
        .project-block-carousel-wrap { position: relative; border-radius: 16px; height: 270px; border: 1px solid rgba(255,255,255,0.10); background: rgba(255,255,255,0.02); overflow: hidden; }
        .project-block-carousel { height: 100%; overflow-x: auto; }
        .project-block-carousel::-webkit-scrollbar { display:none; }
        .project-block-track { display: flex; align-items: center; height: 100%; }
        .project-block-item { width: 250px; height: 250px; flex: 0 0 auto; margin-right: 10px; }
        .project-block-item img { width: 100%; height: 100%; object-fit: contain; border-radius: 12px; border: 2px solid transparent; background: rgba(255,255,255,0.90); box-shadow: 0 4px 20px rgba(0,0,0,0.20); }
        .project-block-item img:hover { transform: scale(1.03); border-color: var(--gold); box-shadow: 0 8px 30px rgba(255, 215, 0, 0.25); }
        .pbc-btn { position:absolute; top:50%; transform: translateY(-50%); width:45px; height:45px; border-radius:50%; border:none; cursor:pointer; z-index:2; opacity:0.92; background: var(--accent); color:#fff; box-shadow: 0 4px 15px rgba(0,0,0,0.30); }
        .pbc-btn:hover { opacity:1; background: var(--sky); color: var(--navy); }
        .pbc-prev { left: 10px; }
        .pbc-next { right: 10px; }
        .project-block-carousel { scroll-snap-type: x mandatory; padding: 10px 60px 10px 10px; }
        .project-block-item { scroll-snap-align: start; }
...
.video-card.landscape .video-media{ aspect-ratio: 16/9; }
.video-card.portrait .video-media{ max-height: 70vh; }
.video-card.portrait .video-player{ height:auto; max-height: 70vh; }
...
<body>
    ...
    <div class="system-message success fade-out" id="successMessage">
        ...
        <?php 
        switch($success) {
            case '1': echo 'Formulario enviado exitosamente. Nos pondremos en contacto pronto.'; break;
            case '2': echo 'Operación realizada exitosamente.'; break;
    ...
    <div class="system-message error fade-out" id="errorMessage">
        ...
        <?php 
        switch($error) {
            case '1': echo 'Error al enviar el formulario. Por favor intente nuevamente.'; break;
            case '2': echo 'Error en la operación.'; break;
    ...
    <div class="site">
        ...
        <?php
            ...
            foreach ($heroCandidates as $c) {
                if (file_exists($c['abs'])) { $heroRel = $c['rel']; break; }
            }
...
<div class="slider-container">
  ...
  <aside class="rep">
            ...
            $repPhotoRel = null;
            foreach($repCandidates as $c){ if(file_exists($c['abs'])){ $repPhotoRel = $c['rel']; break; } }
        ...
        <section class="quick-properties" id="ofertas">
            ...
            <?php
                function renderPropertyMiniCard($p) {
                    ...
                    if ($sub !== '') { $href .= '&sub=' . urlencode((string)$sub); }
                    if (!empty($title)) {
            ...
            <div class="quick-columns">
                <div class="quick-col">
                    ...
                    <?php $b = bannerFor("venta", $banners); if($b): ?>
                ...
                <div class="quick-col">
                    ...
                    <?php $b = bannerFor("anticretico", $banners); if($b): ?>
                ...
                <div class="quick-col">
                    ...
                    <?php $b = bannerFor("alquiler", $banners); if($b): ?>
...
<section id="constructora" class="constructora-section">
    ...
    try {
        ...
        if (mapEl && window.L && typeof L.map === 'function') {
            ...
            const map = L.map('officeMap', { scrollWheelZoom: false }).setView(officeCoords, 13);
...
(function(){
  ...
  function initDropdown(){
    ...
    btn.addEventListener('click', (e)=>{ e.preventDefault(); setOpen(!dd.classList.contains('open')); });
  ...
  function makeCarousel(opts){
    ...
    try { track.dataset.carouselInit = '1'; container.dataset.carouselInit = '1'; } catch(_) {}
    ...
    // Recalcular
    window.addEventListener('resize', ()=>{ pickScrollEl(); update(); restart(); });
    ...
    setTimeout(()=>{ pickScrollEl(); update(); restart(); }, 300);
...
(function(){
  ...
  function initAutoplay(){
    ...
    carousels.forEach((el)=>{
      ...
      const markInteract = ()=>{ el.dataset.userInteractedAt = String(Date.now()); };
